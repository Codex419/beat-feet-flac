...
class AudioAnalysisPlaygroundGame : ApplicationAdapter() {
    ...
    override fun create() {
        ...
        music = if (isFlac) com.serwylo.beatgame.audio.flac.FlacMusic(musicFile) else Gdx.audio.newMusic(musicFile)
        spectogram = com.serwylo.beatgame.audio.fft.calculateMp3FFTWithValues(musicFile.read(), isFlac)
